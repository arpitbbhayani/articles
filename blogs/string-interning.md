Every programming language aims to be performant in its niche and achieve superior performance requires a lot of compiler and interpreter level optimizations. Since Strings are integral part of any programming language, ability to perform string operations quickly elevates the overall performance of the language. 
